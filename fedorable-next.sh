...
install_starship() {
  curl -fsSL "$STARSHIP_URL" -o /tmp/fedorable_tmp/starship.sh
  run_cmd sudo -u "$ACTUAL_USER" sh /tmp/fedorable_tmp/starship.sh -y
}
install_extras() {
